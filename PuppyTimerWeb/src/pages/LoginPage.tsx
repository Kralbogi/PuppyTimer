    ...
    <div className="min-h-[100dvh] flex flex-col md:flex-row overflow-hidden" style={{ background: "var(--color-bg)" }}>
      ...
      >
        ...
        <div className="relative z-10 text-white max-w-xs w-full">
          ...
          <div className="mb-7 flex items-center gap-4">
            <div className="w-16 h-16 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center shadow-lg text-3xl">
              🐾
            </div>
            <div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12">
        ...
        <div className="md:hidden text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl mb-3 shadow-md"
