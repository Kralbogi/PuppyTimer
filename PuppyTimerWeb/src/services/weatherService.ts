...
const HavaDurumuKodlari: Record<number, { tanim: string; emoji: string }> = {
  0: { tanim: "Açık", emoji: "" },
  1: { tanim: "Az Bulutlu", emoji: "" },
  2: { tanim: "Parçalı Bulutlu", emoji: "" },
  3: { tanim: "Bulutlu", emoji: "" },
  45: { tanim: "Sisli", emoji: "" },
  48: { tanim: "Dondurucu Sis", emoji: "" },
  51: { tanim: "Hafif Çiseleyen", emoji: "" },
  53: { tanim: "Çiseleyen", emoji: "" },
  55: { tanim: "Yoğun Çiseleyen", emoji: "" },
  61: { tanim: "Hafif Yağmurlu", emoji: "" },
  63: { tanim: "Yağmurlu", emoji: "" },
  65: { tanim: "Şiddetli Yağmurlu", emoji: "" },
  71: { tanim: "Hafif Karlı", emoji: "" },
  73: { tanim: "Karlı", emoji: "" },
  75: { tanim: "Yoğun Karlı", emoji: "" },
  77: { tanim: "Kırağılı", emoji: "" },
  80: { tanim: "Sağanak Yağışlı", emoji: "" },
  81: { tanim: "Orta Sağanak", emoji: "" },
  82: { tanim: "Şiddetli Sağanak", emoji: "" },
  85: { tanim: "Kar Fırtınası", emoji: "" },
  86: { tanim: "Yoğun Kar Fırtınası", emoji: "" },
  95: { tanim: "Gök Gürültülü Fırtına", emoji: "" },
  96: { tanim: "Dolu Fırtınası", emoji: "" },
  99: { tanim: "Şiddetli Dolu", emoji: "" },
};
...
function yuruyusUygunlukKontrol(
  ...
  if (sicaklik < -5) {
    return {
      uygun: false,
      mesaj: " Çok soğuk! Kısa yürüyüş yapın ve köpeğinizi sıcak tutun.",
    };
  }
  ...
  if (sicaklik > 32) {
    return {
      uygun: false,
      mesaj: " Çok sıcak! Sabah erken veya akşam geç saatlerde yürüyün.",
    };
  }
  ...
  if (yagis > 5) {
    return {
      uygun: false,
      mesaj: " Yağmurlu! Yağmurluk giydirin veya yağmur kesilene kadar bekleyin.",
    };
  }
  ...
  if (weatherCode >= 95) {
    return {
      uygun: false,
      mesaj: " Fırtınalı! Güvenlik için evde kalın.",
    };
  }
  ...
  if (weatherCode >= 71 && weatherCode <= 77) {
    return {
      uygun: true,
      mesaj: " Karlı! Patileri koruyun ve kısa yürüyüş yapın.",
    };
  }
