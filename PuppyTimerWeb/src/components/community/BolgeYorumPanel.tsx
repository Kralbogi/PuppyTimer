// =============================================================================
// PuppyTimer Web - BolgeYorumPanel
// Topluluk bolgesi yorum paneli
// =============================================================================

import { useState } from "react";
import { X, Send, Trash2, MessageCircle, Loader2, Navigation } from "lucide-react";
import { useBolgeYorumViewModel } from "../../hooks/useBolgeYorumViewModel";
import type { ToplulukBolge } from "../../types/models";
import { icerikGecerliMi } from "../../utils/validationUtils";

interface BolgeYorumPanelProps {
  bolge: ToplulukBolge;
  onKapat: () => void;
  onYolTarifi?: () => void;
}
...
export function BolgeYorumPanel({ bolge, onKapat, onYolTarifi }: BolgeYorumPanelProps) {
  const {
    yorumlar,
    yukleniyor,
    hata,
    ...
    yorumYaz,
    yorumKaldir,
  } = useBolgeYorumViewModel(bolge.id);
