...
const AnimatedDog3D: React.FC<AnimatedDog3DProps> = React.memo(({
  irk,
  size = 200,
  fotoData,
  customColors,
...
// Memoize AnimatedDog3D to prevent unnecessary Canvas re-renders
// Canvas is expensive - only re-render when breed, colors, or accessories change
AnimatedDog3D.displayName = 'AnimatedDog3D';
