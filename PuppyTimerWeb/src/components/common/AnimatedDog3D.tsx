      ...
      {showColorPicker && (
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            <label style={{ fontSize: 11, fontWeight: 600, color: "#666" }}>Ana:</label>
            <input
              type="color"
              value={visuals.primary}
              onChange={(e) => handleColorChange('primary', e.target.value)}
              style={{ width: 32, height: 32, border: "none", borderRadius: 6, cursor: "pointer" }}
            />
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            <label style={{ fontSize: 11, fontWeight: 600, color: "#666" }}>İkincil:</label>
            <input
              type="color"
              value={visuals.secondary}
              onChange={(e) => handleColorChange('secondary', e.target.value)}
              style={{ width: 32, height: 32, border: "none", borderRadius: 6, cursor: "pointer" }}
            />
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            <label style={{ fontSize: 11, fontWeight: 600, color: "#666" }}>Karın:</label>
            <input
              type="color"
              value={visuals.belly}
              onChange={(e) => handleColorChange('belly', e.target.value)}
              style={{ width: 32, height: 32, border: "none", borderRadius: 6, cursor: "pointer" }}
            />
          </div>
        </div>
