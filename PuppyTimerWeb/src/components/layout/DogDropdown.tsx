...
const DogDropdown: React.FC<DogDropdownProps> = React.memo(({
  dogs,
  selectedId,
  onSelect,
  onAdd,
  ...
  // Memoize handleAdd to prevent unnecessary re-renders
...
// Memoized DogDropdown to prevent unnecessary re-renders
// Only re-renders when dogs, selectedId, onSelect, or onAdd actually change
DogDropdown.displayName = 'DogDropdown';
