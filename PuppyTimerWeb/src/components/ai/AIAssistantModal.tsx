// =============================================================================
// PuppyTimer Web - AI Assistant Modal
...
const AIAssistantModal: React.FC<AIAssistantModalProps> = ({
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: `Merhaba! Ben PuppyTimer AI asistanınızım. ${dogName}${
        dogBreed ? ` (${dogBreed})` : ""
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-gray-800 rounded-t-2xl sm:rounded-2xl w-full max-w-2xl max-h-[85vh] flex flex-col"
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-700">
            <div className="flex gap-2">
              <input
                ...
                disabled={isLoading}
                className="flex-1 px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 outline-none transition-all disabled:bg-gray-50 dark:disabled:bg-gray-800"
              />
              <button
                type="button"
                onClick={handleSend}
